					...
					.onSuccess(new OnSuccess<Object>() {
						...
						public void onSuccess(Object result) throws Throwable {
							...
							for (Instance taskManager : taskManagers) {
								...
								String queryServicePath = taskManagerPath.substring(0, taskManagerPath.lastIndexOf('/') + 1) + "MetricQueryService_" + taskManager.getTaskManagerID().getResourceIdString();

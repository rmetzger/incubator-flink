...
class PojoDirectFieldAccessor {
	...
	public FlatFieldDescriptor pojoField; // TODO: I'm not setting this everywhere

	public PojoDirectFieldAccessor(List<Field> accessorChain, Field field, FlatFieldDescriptor pojoField) {
	...
	public String toString() {
		...
		return "Pojo Direct Field Accessor" + accessorChain.get(0).getDeclaringClass() + "." + fields + " (" + pojoField.getType() + ")";
	}
}
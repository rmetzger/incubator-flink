...
public class KryoSerializer<T> extends TypeSerializer<T> {
	...
	private void checkKryoInitialized() {
		if (this.kryo == null) {
			...
			// avro serializer for classes generated by avro
			if(type.isAssignableFrom(SpecificRecordBase.class)) {
				...
				this.kryo.addDefaultSerializer(type.getClass(), com.twitter.chill.avro.AvroSerializer.SpecificRecordSerializer(tag));
			}

...
public class KafkaProducerITCase extends KafkaTestBase {
	...
	public void testCustomPartitioning() {
		try {
			...
			stream.addSink(new FlinkKafkaProducerBase<>(topic, serSchema, FlinkKafkaProducerBase.getPropertiesFromBrokerList(brokerConnectionStrings), new CustomPartitioner(parallelism)))

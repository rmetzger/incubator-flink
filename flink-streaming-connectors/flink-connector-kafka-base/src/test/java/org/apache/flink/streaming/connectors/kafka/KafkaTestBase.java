...
/*	protected abstract <T> FlinkKafkaConsumerBase<T> getConsumer(
	...
	public static void prepare() throws IOException, ClassNotFoundException {
		...
		Class<?> clazz = Class.forName("org.apache.flink.streaming.connectors.kafka.KafkaServerProviderImpl");
		kafkaServer = (KafkaServerProvider) InstantiationUtil.instantiate(clazz);

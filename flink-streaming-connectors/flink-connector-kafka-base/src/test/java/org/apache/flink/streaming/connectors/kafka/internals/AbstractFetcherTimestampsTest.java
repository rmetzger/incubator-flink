...
public class AbstractFetcherTimestampsTest {
	...
	public void testPunctuatedWatermarks() throws Exception {
		...
		fetcher.emitRecord(1L, part1, new ConsumerRecord<byte[], byte[]>(testTopic, 7, new byte[]{0}, 1L));
		fetcher.emitRecord(2L, part1, new ConsumerRecord<byte[], byte[]>(testTopic, 7, new byte[]{0}, 2L));
		fetcher.emitRecord(3L, part1, new ConsumerRecord<byte[], byte[]>(testTopic, 7, new byte[]{0}, 3L));
		assertEquals(3L, sourceContext.getLatestElement().getValue().longValue());
		assertEquals(3L, sourceContext.getLatestElement().getTimestamp());
		assertFalse(sourceContext.hasWatermark());

		// elements for partition 2
		fetcher.emitRecord(12L, part2, new ConsumerRecord<byte[], byte[]>(testTopic, 13, new byte[]{0}, 1L));
		...
		fetcher.emitRecord(101L, part3, new ConsumerRecord<byte[], byte[]>(testTopic, 21, new byte[]{0}, 1L));
		fetcher.emitRecord(102L, part3, new ConsumerRecord<byte[], byte[]>(testTopic, 21, new byte[]{0}, 2L));
		...
		// advance partition 3
		fetcher.emitRecord(1003L, part3, new ConsumerRecord<byte[], byte[]>(testTopic, 21, new byte[]{0}, 3L));
		fetcher.emitRecord(1004L, part3, new ConsumerRecord<byte[], byte[]>(testTopic, 21, new byte[]{0}, 4L));
		fetcher.emitRecord(1005L, part3, new ConsumerRecord<byte[], byte[]>(testTopic, 21, new byte[]{0}, 5L));
		...
		fetcher.emitRecord(30L, part1, new ConsumerRecord<byte[], byte[]>(testTopic, 7, new byte[]{0}, 4L));
		...
		fetcher.emitRecord(13L, part2,  new ConsumerRecord<byte[], byte[]>(testTopic, 13, new byte[]{0}, 2L));
		assertFalse(sourceContext.hasWatermark());
		fetcher.emitRecord(14L, part2, new ConsumerRecord<byte[], byte[]>(testTopic, 13, new byte[]{0}, 3L));
		assertFalse(sourceContext.hasWatermark());
		fetcher.emitRecord(15L, part2, new ConsumerRecord<byte[], byte[]>(testTopic, 13, new byte[]{0}, 3L));
		assertTrue(sourceContext.hasWatermark());

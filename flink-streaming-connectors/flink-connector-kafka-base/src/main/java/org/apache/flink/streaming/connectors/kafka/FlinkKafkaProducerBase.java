 ...
 */
public class FlinkKafkaProducerBase<IN> extends RichSinkFunction<IN>  {
	 ...
	 */
	public FlinkKafkaProducerBase(String brokerList, String topicId, SerializationSchema<IN> serializationSchema) {
	 ...
	 */
	public FlinkKafkaProducerBase(String topicId, SerializationSchema<IN> serializationSchema, Properties producerConfig) {
	 ...
	 */
	public FlinkKafkaProducerBase(String topicId, SerializationSchema<IN> serializationSchema, Properties producerConfig, KafkaPartitioner customPartitioner) {
	 ...
	 */
	public FlinkKafkaProducerBase(String brokerList, String topicId, KeyedSerializationSchema<IN> serializationSchema) {
	 ...
	 * 			Properties with the producer configuration.
	 */
	public FlinkKafkaProducerBase(String topicId, KeyedSerializationSchema<IN> serializationSchema, Properties producerConfig) {

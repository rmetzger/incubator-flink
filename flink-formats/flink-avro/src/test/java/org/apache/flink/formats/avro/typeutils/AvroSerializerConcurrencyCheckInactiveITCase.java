 ...
 */
public class AvroSerializerConcurrencyCheckInactiveITCase extends TestLogger {
	...
	public void testWithNoConcurrencyCheck() throws Exception {
		...
		// the AvroSerializer.CONCURRENT_ACCESS_CHECK will be enabled, causing a failure here.
